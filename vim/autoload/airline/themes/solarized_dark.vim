let g:airline#themes#solarized_dark#palette = {}

function! airline#themes#solarized_dark#refresh()
  """"""""""""""""""""""""""""""""""""""""""""""""
  " Options
  """"""""""""""""""""""""""""""""""""""""""""""""
  let s:background           = get(g:, 'airline_solarized_dark_bg', &background)
  let s:ansi_colors          = get(g:, 'airline_solarized_dark_termcolors', 16) != 256 && &t_Co >= 16 ? 1 : 0
  let s:use_green            = get(g:, 'airline_solarized_dark_normal_green', 0)
  let s:dark_inactive_border = get(g:, 'airline_solarized_dark_dark_inactive_border', 0)
  let s:tty                  = &t_Co == 8
  ...
  " Via https://github.com/blueyed/vim-colors-solarized_dark/commit/92f2f994 /
  " https://github.com/cuviper/vim-colors-solarized_dark.
  if s:ansi_colors && get(g:, 'solarized_dark_base16', 0)
    ...
    let s:base01  = {'t': s:ansi_colors ?  10 : (s:tty ? '0' : 239), 'g': '#586e75'}
    let s:base00  = {'t': s:ansi_colors ?  11 : (s:tty ? '7' : 240), 'g': '#657b83'}
    let s:base0   = {'t': s:ansi_colors ?  12 : (s:tty ? '7' : 244), 'g': '#839496'}
    let s:base1   = {'t': s:ansi_colors ?  14 : (s:tty ? '7' : 245), 'g': '#93a1a1'}
    let s:base2   = {'t': s:ansi_colors ?   7 : (s:tty ? '7' : 187), 'g': '#eee8d5'}
    ...
    let s:red     = {'t': s:ansi_colors ?   1 : (s:tty ? '1' : 124), 'g': '#dc322f'}
  ...
  if s:background == 'dark'
    ...
    "let s:N2 = [s:base2, (s:tty ? s:base01 : s:base03), '']
    "let s:N3 = [s:base01, s:base02, '']
    let s:N1 = [s:base02, s:green, 'bold']
    let s:N2 = [s:base2, s:base03, '']
  ...
  " Inactive, according to VertSplit in solarized_dark
  ...
  let g:airline#themes#solarized_dark#palette.accents = {
        \ 'red': s:NFa,
        \ }

  let g:airline#themes#solarized_dark#palette.inactive = airline#themes#generate_color_map(
        \ [s:IA[0].g, s:IA[1].g, s:IA[0].t, s:IA[1].t, s:IA[2]],
        \ [s:IA[0].g, s:IA[1].g, s:IA[0].t, s:IA[1].t, s:IA[2]],
        \ [s:IA[0].g, s:IA[1].g, s:IA[0].t, s:IA[1].t, s:IA[2]])
  let g:airline#themes#solarized_dark#palette.inactive_modified = {
        \ 'airline_c': [s:NMi[0].g, '', s:NMi[0].t, '', s:NMi[2]]}

  let g:airline#themes#solarized_dark#palette.normal = airline#themes#generate_color_map(
        \ [s:N1[0].g, s:N1[1].g, s:N1[0].t, s:N1[1].t, s:N1[2]],
        \ [s:N2[0].g, s:N2[1].g, s:N2[0].t, s:N2[1].t, s:N2[2]],
        \ [s:N3[0].g, s:N3[1].g, s:N3[0].t, s:N3[1].t, s:N3[2]])

  let g:airline#themes#solarized_dark#palette.normal.airline_warning = [
        \ s:NW[0].g, s:NW[1].g, s:NW[0].t, s:NW[1].t, s:NW[2]]

  let g:airline#themes#solarized_dark#palette.normal.airline_error = [
        \ s:NW[0].g, s:NW[1].g, s:NW[0].t, s:NW[1].t, s:NW[2]]

  let g:airline#themes#solarized_dark#palette.normal_modified = {
        \ 'airline_c': [s:NM[0].g, s:NM[1].g,
        \ s:NM[0].t, s:NM[1].t, s:NM[2]]}

  let g:airline#themes#solarized_dark#palette.normal_modified.airline_warning =
        \ g:airline#themes#solarized_dark#palette.normal.airline_warning

  let g:airline#themes#solarized_dark#palette.insert = airline#themes#generate_color_map(
        \ [s:I1[0].g, s:I1[1].g, s:I1[0].t, s:I1[1].t, s:I1[2]],
        \ [s:I2[0].g, s:I2[1].g, s:I2[0].t, s:I2[1].t, s:I2[2]],
        \ [s:I3[0].g, s:I3[1].g, s:I3[0].t, s:I3[1].t, s:I3[2]])

  let g:airline#themes#solarized_dark#palette.insert.airline_warning =
        \ g:airline#themes#solarized_dark#palette.normal.airline_warning

  let g:airline#themes#solarized_dark#palette.insert_modified = {
        \ 'airline_c': [s:IM[0].g, s:IM[1].g,
        \ s:IM[0].t, s:IM[1].t, s:IM[2]]}

  let g:airline#themes#solarized_dark#palette.insert_modified.airline_warning =
        \ g:airline#themes#solarized_dark#palette.normal.airline_warning

  let g:airline#themes#solarized_dark#palette.visual = airline#themes#generate_color_map(
  ...
  let g:airline#themes#solarized_dark#palette.visual.airline_warning =
        \ g:airline#themes#solarized_dark#palette.normal.airline_warning

  let g:airline#themes#solarized_dark#palette.visual_modified = {
        \ 'airline_c': [s:VM[0].g, s:VM[1].g,
        \ s:VM[0].t, s:VM[1].t, s:VM[2]]}

  let g:airline#themes#solarized_dark#palette.visual_modified.airline_warning =
        \ g:airline#themes#solarized_dark#palette.normal.airline_warning

  let g:airline#themes#solarized_dark#palette.replace = airline#themes#generate_color_map(
  ...
  let g:airline#themes#solarized_dark#palette.replace.airline_warning =
        \ g:airline#themes#solarized_dark#palette.normal.airline_warning

  let g:airline#themes#solarized_dark#palette.replace_modified = {
        \ 'airline_c': [s:RM[0].g, s:RM[1].g,
        \ s:RM[0].t, s:RM[1].t, s:RM[2]]}

  let g:airline#themes#solarized_dark#palette.replace_modified.airline_warning =
        \ g:airline#themes#solarized_dark#palette.normal.airline_warning

  let g:airline#themes#solarized_dark#palette.tabline = {}

  let g:airline#themes#solarized_dark#palette.tabline.airline_tab = [
        \ s:I2[0].g, s:I2[1].g, s:I2[0].t, s:I2[1].t, s:I2[2]]

  let g:airline#themes#solarized_dark#palette.tabline.airline_tabtype = [
        \ s:N2[0].g, s:N2[1].g, s:N2[0].t, s:N2[1].t, s:N2[2]]
endfunction

call airline#themes#solarized_dark#refresh()
