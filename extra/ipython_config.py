...
#  Default: "Python 3.13.2 (main, Mar 11 2025, 17:25:02) [Clang 20.1.0 ]\nType 'copyright', 'credits' or 'license' for more information\nIPython 9.0.2 -- An enhanced Interactive Python. Type '?' for help.\n"
# c.InteractiveShell.banner1 = "Python 3.13.2 (main, Mar 11 2025, 17:25:02) [Clang 20.1.0 ]\nType 'copyright', 'credits' or 'license' for more information\nIPython 9.0.2 -- An enhanced Interactive Python. Type '?' for help.\n"
import sys
import IPython
c.InteractiveShell.banner1 = f'Python {sys.version}\nIPython {IPython.__version__}\n'
...
# This disables the background highlighted suggestions
c.TerminalInteractiveShell.autosuggestions_provider = None

## The part of the banner to be printed before the profile
#  See also: InteractiveShell.banner1
# c.TerminalInteractiveShell.banner1 = "Python 3.13.2 (main, Mar 11 2025, 17:25:02) [Clang 20.1.0 ]\nType 'copyright', 'credits' or 'license' for more information\nIPython 9.0.2 -- An enhanced Interactive Python. Type '?' for help.\n"
...
c.TerminalInteractiveShell.shortcuts = [
    {
        # backward_kill_word is the [0-9a-zA-Z_] delimited word rubout that we want,
        # don't restrict it to only vi_insert_mode, allow it in emacs editing too.
        # This doesn't match on underscores like my zsh does, but registering a whole
        # new custom command is way more difficult and I don't think is possible from
        # the config file itself.
        'match_keys': ['c-w'],
        'match_filter': 'vi_insert_mode & default_buffer_focused & ebivim',
